...
// Route::get('/transaksi_detail',[DetailTransaksiController::class ,'index']);

Route::get('/transaksidetail/detail/{id}',[DetailTransaksiController::class ,'index']);
Route::get('/transaksidetail/tambah', [DetailTransaksiController::class,'create']);
Route::post('/transaksidetail/store', [DetailTransaksiController::class,'store']);
Route::get('/transaksidetail/edit/{id}', [DetailTransaksiController::class,'edit']);
Route::put('/transaksidetail/update/{id}', [DetailTransaksiController::class,'update']);
Route::get('/transaksidetail/destroy/{id}', [DetailTransaksiController::class,'destroy']);
